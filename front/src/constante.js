...
export const ROUTE_PAYMENT_EDIT = '/paiements/:id/edit';

export const ROUTE_TABLES = '/tables';
export const ROUTE_TABLE_CREATE = '/tables/new';
export const ROUTE_TABLE_EDIT = '/tables/:id/edit';
