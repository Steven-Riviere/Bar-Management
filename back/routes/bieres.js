...
router.delete("/:id", authenticate, authorize('ADMIN', 'GERANT', 'BARMAN'), controller.deactivate);
router.patch("/:id", authenticate, authorize('ADMIN', 'GERANT', 'BARMAN'), controller.restore)
