...
router.delete("/:id", authenticate, authorize("ADMIN", "GERANT"), controller.deactivateBar);
router.patch("/:id", authenticate, authorize("ADMIN", "GERANT"), controller.restoreBar);
